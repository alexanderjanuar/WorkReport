            ...
            {twoFactorEnabled ? (
                <div className="flex flex-col items-start justify-start space-y-4">
                    <p className="text-sm text-muted-foreground">
                        ...
                        masuk, yang bisa Anda dapatkan dari aplikasi pendukung
                        TOTP di ponsel Anda.
                    </p>
                ...
                <div className="flex flex-col items-start justify-start space-y-4">
                    <p className="text-sm text-muted-foreground">
                        ...
                        diminta memasukkan PIN yang aman saat masuk. PIN ini bisa
                        didapatkan dari aplikasi pendukung TOTP di ponsel Anda.
                    </p>
